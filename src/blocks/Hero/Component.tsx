      ...
      <div className="km-container km-hero-grid">
        ...
        <div className="km-hero-copy">
          ...
          {(socialLinks?.github || socialLinks?.linkedin) && (
            <div className="km-hero-socials km-reveal mt-7 flex gap-2.5">
              {socialLinks?.github && (
                <a
                ...
                >
                  <span className="size-8.5 grid place-items-center rounded-[10px] border border-(--border) text-(--text-dim)">
                    <svg viewBox="0 0 24 24" fill="currentColor" className="size-3.75">
